...
public class SimulationTests {
        ...
        private void runSimulation(String scenarioName, UserContext context) {
                ...
                try {
                        ...
                        System.out.println(
                                        "COST RANGE: " + (verdict.getCostRange() != null
                                                        ? verdict.getCostRange().getLabel()
                                                        : "N/A"));
                        System.out.println(
                                        "EXACT ESTIMATE: $" + String.format("%,.2f", verdict.getExactCostEstimate()));
                        ...
                        if (verdict.getContextBriefing() != null) {
                                System.out.println("\nCONTEXT BRIEFING:");
                                System.out.println(
                                                "  Regional Risk: " + verdict.getContextBriefing().getRegionalRisk());
                                System.out.println("  Era Feature: " + verdict.getContextBriefing().getEraFeature());
                                System.out.println(
                                                "  Labor Market: " + verdict.getContextBriefing().getLaborMarketRate());
                        }
